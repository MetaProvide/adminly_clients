...
class Provider implements IProvider {
	...
	public function parse($language, IEvent $event, IEvent $previousEvent = null) {
		...
		if ($this->activityManager->getRequirePNG()) {
			$event->setIcon($this->url->getAbsoluteURL($this->url->imagePath('/custom_apps/adminly_clients/', 'app-dark.png')));
		} else {
			$event->setIcon($this->url->getAbsoluteURL($this->url->imagePath('/custom_apps/adminly_clients/', 'app-dark.svg')));
		}
